...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://ghdown.lxy0.com/https://raw.githubusercontent.com/CellLz/Multi-EasyGost/refs/heads/v2/gost.sh && chmod +x gost.sh && ./gost.sh`  
